    ...
    <div className="min-h-screen bg-[#F5F7FA] flex items-center justify-center px-6 font-Inter">
      <div className="max-w-md w-full text-center space-y-8">
        <div className="relative">
          <h1 className="text-[12rem] font-bold text-[#F4A800]/5 leading-none select-none">403</h1>
          <div className="absolute inset-0 flex items-center justify-center">
             <div className="w-24 h-24 bg-white rounded-3xl shadow-xl flex items-center justify-center">
                <ShieldAlert className="w-12 h-12 text-[#1A3A6B]" />
             </div>
          </div>
        </div>

        <div className="space-y-3">
          <h2 className="text-3xl font-bold text-[#1A3A6B]">Access Denied</h2>
          <p className="text-slate-400 font-medium leading-relaxed">
            You don't have the necessary permissions to access this scholarly restricted area. Please return to your designated dashboard.
          </p>
        </div>
