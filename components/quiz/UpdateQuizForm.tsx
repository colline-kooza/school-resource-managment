...
export const UpdateQuizForm = ({ quizId }: { quizId: string }) => {
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      if (e.response?.status === 400) {
        toast.error(e.response.data || "Please check your quiz setup");
      }
    } finally {
      setLoading(false);
    }
  ...
  if (fetching) return (
    <div className="flex flex-col items-center justify-center p-20 gap-4 text-slate-400">
      ...
      <p className="font-bold uppercase text-[10px] tracking-widest">Loading Quiz Data...</p>
    </div>
  );
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
          ...
          {step === 3 && (
            <div className="bg-white rounded-[40px] p-12 border border-slate-100 shadow-sm text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <h3 className="text-3xl font-bold text-[#1A3A6B] mb-4">Changes Ready!</h3>
              <p className="text-slate-500 font-medium mb-12 max-w-sm mx-auto">
                You've updated "{form.watch("title")}" with {fields.length} questions.
              </p>
              ...
              <div className="flex flex-col gap-4 max-w-xs mx-auto">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                  Updated questions will be saved to your draft.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center justify-between mt-12">
            ...
            {step < 3 && (
              ...
              >
                Next: {step === 1 ? "Edit Questions" : "Final Review"}
