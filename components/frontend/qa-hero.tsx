...
export default function QaHero() {
  return (
    <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mt-10 max-w-xl mx-auto">
          <form onSubmit={(e) => e.preventDefault()} className="flex w-full max-w-sm items-center space-x-2 mx-auto">
            ...
            />
            <Button type="submit" className="bg-purple-500 hover:bg-purple-400 text-white">
