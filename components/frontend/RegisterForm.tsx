...
import FormSelectInput from "../backend/FormInputs/FormSelectInput";
import SelectInput from "../backend/FormInputs/SelectInput";


export default function RegisterForm({course,campus}:{course:any,campus:any}) {
